package com.dshovhenia.vimeo.paging.compose.sample.data.local.db

import androidx.room.Database
import androidx.room.RoomDatabase
import androidx.room.TypeConverters
import com.dshovhenia.vimeo.paging.compose.sample.data.local.db.dao.comment.CommentDao
import com.dshovhenia.vimeo.paging.compose.sample.data.local.db.dao.pictures.PictureSizesDao
import com.dshovhenia.vimeo.paging.compose.sample.data.local.db.dao.user.UserDao
import com.dshovhenia.vimeo.paging.compose.sample.data.local.db.dao.video.VideoDao
